...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'racelines', 'sensitivity', 'alat'), glob('racelines/sensitivity/alat/*.csv')),
        (os.path.join('share', package_name, 'racelines', 'sensitivity', 'alpha'), glob('racelines/sensitivity/alpha/*.csv')),
        (os.path.join('share', package_name, 'racelines', 'sensitivity', 'cdyn'), glob('racelines/sensitivity/cdyn/*.csv')),
        (os.path.join('share', package_name, 'racelines', 'sensitivity', 'tmargin'), glob('racelines/sensitivity/tmargin/*.csv')),
        (os.path.join('share', package_name, 'racelines', 'sensitivity', 'wcte'), glob('racelines/sensitivity/wcte/*.csv')),
