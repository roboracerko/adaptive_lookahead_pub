...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('run_tag', default_value='pp_adaptive_visual_test'),
        ...
        DeclareLaunchArgument(
            ...
            description='Raceline path for pp_adaptive visual test (default: RL Budapest_optimal converted CSV)',
        ),
        DeclareLaunchArgument(
